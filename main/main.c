...
#define HC_SR04_TRIGGER 25
#define HC_SR04_ECHO 26
...
#define MAX_DISTANCE_CM 5000 // Distancia maxima 50 metros
...
// Obtem dados do sensor Acelerometro MPU6050
void task_mpu6050() {
...
void Task_SendReceive ( void * pvParameter ) 
{
	...
	const char * msg_post = \
        ...
        "Connection: close\n"
        "X-THINGSPEAKAPIKEY: FNPK6J76KR57KGJZ\n"
        "Content-Type: application/x-www-form-urlencoded\n"
        "content-length: ";
		
	char databody[399];
  	sprintf( databody, "{FNPK6J76KR57KGJZ&field1=%d&field2=%d&field3=%d&field4=%0.04f}", xSocket->x_accel, xSocket->y_accel, xSocket->z_accel, xSocket->distance);
...
void app_main(void)
{
	...
	if( xTaskCreate( task_hc_sr04, "ultrasonic_test", configMINIMAL_STACK_SIZE * 3, NULL, 5, NULL) != pdTRUE )
	{
